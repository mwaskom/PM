...
for i = 1:length(coh_set_signed)
    ...
    beta = logistfit([ones(1,length(coh_signed )); (coh_signed' .* idx.cleanResp); (idx.resp_face .* idx.cleanResp)]');
