...
con.respFaceVsRespHouse_coh0= (idx.coh0Face - idx.coh0House) .* idx.bf1 ;

%con.faceVsHouse_corOnly_with0coh = con.faceVsHouse_corOnly + con.respFaceVsRespHouse_coh0;
%con.houseVsFace_corOnly_with0coh = con.houseVsFace_corOnly - con.respFaceVsRespHouse_coh0;
...
for f = 1:length(fn)
    ...
    con.(thisConName) = idx.(fn{f}) .* idx.bf1;
end
