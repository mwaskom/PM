function PM_setcontrastsPerc_by_Ev(subpar)
...
idx.ev = ~cellfun('isempty', strfind(regNames,'evidence'));
...
con.Ev_vs_fix = (idx.ev);
con.faceEv_vs_fix = (idx.ev .* idx.face);
con.houseEv_vs_fix = (idx.ev .* idx.house);
con.faceEv_vs_houseEv = (idx.ev .* (idx.face - idx.house));
