...
%
 percdirConf = fullfile(analysisdir, 'analysisPercByAllConf', 'AllConf', 'spmT_0001.img');
 mnemdirConf = fullfile(analysisdir, 'analysisRetByAllConf', 'AllConf', 'spmT_0001.img');
...
outputdir = '/biac4/wagner/biac3/wagner5/alan/perceptMnemonic/fmri_data/group_analyses/percMnemConj_parModByConf';
...
outputfile = fullfile(outputdir, 'conj_ConfAll_p.005_acrossPercAndMnem.img');
