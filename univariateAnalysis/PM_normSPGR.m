...
fprintf('---Normalizing funcs for Subject %s---\n',par.substr);

hiresimg = par.hiresimg;
graywrimg = par.graywrimg;
spgrnrmflags = par.spgrnrmflags;
[grpth,grnm] = fileparts(graywrimg);
grmatname        = fullfile(grpth,[grnm '_sn.mat']);

spm_write_sn(hiresimg, grmatname,spgrnrmflags);

fprintf('---Normalizing SPGR COMPLETED for Subject %s---\n',par.substr);
