...
fileNames = {'Roozbeh_pilot1_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot2_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot3_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot4_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot5_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot6_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot7_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot8_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot9_08-16-2010_21-19-42.mat'
             'Roozbeh_pilot10_08-16-2010_21-19-42.mat'};
...
coh_set_binned = {[0] [.15 .2 .25 .35 .45 .6 1]};
...
for r=1:length(resp_set)
    idx.thisOns = (coh_==0) .* idx.(resp_set{r}) ;
...
for l=1:length(class_set)
     for p=1:length(perf_set)       
            idx.thisOns = (coh_~=0) .* idx.(perf_set{p}) .* idx.(class_set{l});
            if ~isempty(alltrials(find(idx.thisOns)))
                i = i+1;
...
%                 
%                 
%                 idx.thisOns = (coh_==coh_set(c)) .* idx.(perf_set{p}) .* idx.(class_set{l});
%                 
%                 if ~isempty(alltrials(find(idx.thisOns)))
%                     
%                     i = i+1;
%                     fName = sprintf('%s_coh%s_%s', class_set{l}, num2str(coh_set_pct(c)), perf_set{p});
%                     
%                     
%                     
%                     %ons.(fName) =
